...
close all
clc
digitDatasetPath='C:\Users\CSMIGHEY\Documents\Task4\CNN_PCA_PNN\sent\CPP_Iffat1\Database';
...
%MeanX=column means of training inputs
%}
thr=99; 
[PCX,vv,MeanX]=PCM(featuresTrain,thr);
outputDir = "C:\Users\CSMIGHEY\Documents\Task4\CNN_PCA_PNN\sent\CPP_Iffat1";
outputFile = fullfile(outputDir, "PCX.mat");
save(outputFile, "PCX");
outputFile = fullfile(outputDir, "MeanX.mat");
save(outputFile, "MeanX");
%project  the datapoints onto the Principal components
inputs=featuresTrain;
[projectedInputs]=PCAInputTransformation(inputs,PCX,MeanX);
